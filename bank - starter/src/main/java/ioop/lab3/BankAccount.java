...
public class BankAccount {
    ...
    public static void main(String[] args) {
        BankAccount accountOne = new BankAccount("Batwest", "Bruce Wayne", "Mr", 10);
        BankAccount accountTwo = new BankAccount("Natwest", "John Wayne", "Mr", 0);
        DebitAccount accountThree = new DebitAccount("BatBank", "Cousin Ricky", "Mr", 0);
        ...
        bigBank.addBankAccount(accountOne);
        bigBank.addBankAccount(accountTwo);
        System.out.println(bigBank.getBankAccounts());
        bigBank.removeBankAccount(accountTwo);
        System.out.println(bigBank.getBankAccounts());
        accountThree.processTransaction('d', 50);
    }
}
